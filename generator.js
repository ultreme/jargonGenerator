...
/*
** function that write a generated sentence
** pPatterns is an array contaning all generateds sentences
*/
function showRandomSentence(pPatterns) {
	window.document.write(genScene(pickRandomElementInArray(patterns)));
}

/*
** function that shows all patterns examples, to check if all is fine or debug
*/
function showAllSentences(pPatterns) {
...
** pattern 0
*/
patterns.push("Si vous voulez, les :WORD_LE:s se catégorisent de 2 sortes:<br />- les :WORD_LE:s qui se calibrent en :ADJ_M:<br />- les :WORD_LA:s qui se calibrent par :ADJ_F:s");

/*
** pattern 1
*/
patterns.push("On doit absolument :VERB_INF: le :WORD_LE: ASAP ! Autrement vous pouvez être sûr que le groupe :WORD_LE: va vous péter à la figure !");

/*
** pattern 2
*/
randomNb = rand(2, 10);
tempPattern = "Pardon de vous reprendre, mais les choses ne sont pas aussi simples. Voyez-vous, quand vous :VERB:z les :WORD_LE:s, cela implique " + randomNb + " choses: ";
for (let i = 0; i < randomNb; i++) {
	tempPattern += "<br />- Le :WORD_LE: du :WORD_LE: :VERB: le :WORD_LE: du :WORD_LE:";
}
...
** pattern 3
*/
patterns.push("je :VERB:, tu :VERB_TU: et il faut :VERB_INF: pour que tout soit :VERB_PAST: !");

/*
** pattern 4
*/
patterns.push("J'aime bien :VERB_INF: les :WORD_LE:s !");

/*
** pattern 5
*/
patterns.push("Tu peux me passer le :WORD_LE: steup ? <br />Tu veux pas plutôt un :WORD_LE: pour :VERB_INF: le :WORD_LE: ? C'est quand même plus :ADJ_M:.. <br />T'as raison Johnny ! Bon sang ce que tu es doué en :WORD_LA: !");

/*
** pattern 6
*/
patterns.push("Nan mais comment en " + rand(2000, 2019) + " on peut encore :VERB_INF: des :WORD_LE: en :ADJ_M: ? C'est n'importe quoi, c'est évident que tu :VERB_TU: les :WORD_LE:s par :WORD_LE: :ADJ_M:s quoi nan mais genre what ? Mais genre allô quoi enfin genre 'fin genre whaattt ???");

/*
** pattern 7
*/
randomNb = rand(2, 10);
tempPattern = "Nan mais je t'explique, le :WORD_LE: ça se setup en " + randomNb + " étapes:<br />";
for (let i = 0; i < randomNb; i++) {
	tempPattern += (i + 1) + ") tu :VERB_TU: le :WORD_LE: en :ADJ_M:<br />";
}

tempPattern += "<br />Si le truc explose en cours de route, c'est que t'as oublié de :VERB_INF:.";
patterns.push(tempPattern);

/*
** pattern 8
*/
patterns.push( "Il y a 2 sortes de :WORD_LE:<br />- Les cools<br />- Les chiants<br />");

/*
** pattern 9
*/
randomNb = rand(2, 30);
tempPattern = "Il y a très exactement " + randomNb + " catégories de :WORD_LE::<br />";
for (let i = 0; i < randomNb; i++) {
	tempPattern += "- Ceux qui sont :ADJ_M: <br />";
}
...
*/
randomNb = rand(2, 30);
tempPattern = "il y a très exactement " + randomNb + " catégories de :WORD_LA::<br />";
for (let i = 0; i < randomNb; i++) {
	tempPattern += "- Celles qui sont :ADJ_F:s <br />";
}
...
** pattern 11
*/
patterns.push("Moi j'aime bien :VERB_INF: des :WORD_LA:s. Je pourrais faire ça toute la journée je kiffe j'suis comme ça.");

/*
** Voila
*/
showRandomSentence(patterns);

/*
** If you want to see all patterns
*/
//showAllSentences(Patterns);
